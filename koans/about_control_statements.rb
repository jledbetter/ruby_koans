...
class AboutControlStatements < EdgeCase::Koan
  ...
  def test_unless_statement
    ...
    assert_equal :false_value, result #Question: Come back to this
  end
  ...
  def test_next_statement
    ...
    while i < 10
      i += 1
      next if (i % 2) == 0  #Question: I thought it would do the next line so would be [2, 4, 6, 8, 10]. I was wrong.
      result << i 
    end
