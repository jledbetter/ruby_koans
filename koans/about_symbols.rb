...
class AboutSymbols < EdgeCase::Koan
  ...
  #
  # Since there's just the same internal object, you'd be comparing that identity 
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      assert_equal true, all_symbols.include?(:sound)
    end
  end
  ...
  # 
  # Allocates memory so could cause memory leaks
end
